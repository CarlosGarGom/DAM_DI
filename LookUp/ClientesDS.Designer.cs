...
namespace LookUp.ClientesDSTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LookUp.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT CustomerID, CompanyName FROM dbo.Customers Where (CompanyName LIKE \'%\' +  " +
                "@patron + \'%\') ";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@patron", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "CompanyName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByNombre(ClientesDS.CustomersDataTable dataTable, string patron) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((patron == null)) {
                throw new global::System.ArgumentNullException("patron");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(patron));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
