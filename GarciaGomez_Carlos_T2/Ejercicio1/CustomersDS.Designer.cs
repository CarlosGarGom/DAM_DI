...
namespace Ejercicio1.CustomersDSTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT CustomerID, Country FROM dbo.Customers";
        ...
        public virtual int FillBy(CustomersDS.CustomersDataTable dataTable) {
        ...
        public virtual CustomersDS.CustomersDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CustomersDS.CustomersDataTable dataTable = new CustomersDS.CustomersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
